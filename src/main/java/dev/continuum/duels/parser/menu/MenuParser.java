...
public class MenuParser {
    ...
    public MenuParser(final @NotNull FileConfiguration configuration) {
        this.configuration = configuration;
    }

    public static @NotNull MenuParser wrap(final @NotNull FileConfiguration configuration) {
        return new MenuParser(configuration);
    }
    ...
    public Menu menu() {
        if (this.menu == null) {
            this.menu = Menu.menu(title(), size());
        }
